...
import (
	...
	"github.com/flbla/goharbor-client/v5/apiv2/internal/api/client/user"
...
The package also contains a [`Client` interface](https://github.com/flbla/goharbor-client/blob/master/apiv2/user/user.go#L36) that holds all method signatures:
```go
...
To make the sub-client's methods accessible via the `github.com/flbla/goharbor-client/apiv2` package, 
